                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <img src="<?= base_url('assets/images/couple-working-from-home-together-sofa.jpg') ?>" class="about-image img-fluid" alt="">
                        </div>
                        ...
                        <div class="col-lg-6 col-12 mt-5 mt-lg-0">
                            <div class="about-thumb">
                                ...
                                <div class="section-title-wrap d-flex justify-content-end align-items-center mb-4">
                                    ...
                                    <img src="<?= base_url('assets/images/happy-bearded-young-man.jpg') ?>" class="avatar-image img-fluid" alt="">
                                </div>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-2 col-4 ms-auto clients-item-height">
                            <img src="<?= base_url('assets/images/clients/cachet.svg') ?>" class="clients-image img-fluid" alt="">
                        </div>

                        <div class="col-lg-2 col-4 clients-item-height">
                            <img src="<?= base_url('assets/images/clients/guitar-center.svg') ?>" class="clients-image img-fluid" alt="">
                        </div>

                        <div class="col-lg-2 col-4 clients-item-height">
                            <img src="<?= base_url('assets/images/clients/tokico.svg') ?>" class="clients-image img-fluid" alt="">
                        </div>

                        <div class="col-lg-2 col-4 clients-item-height">
                            <img src="<?= base_url('assets/images/clients/shopify.svg') ?>" class="clients-image img-fluid" alt="">
                        </div>

                        <div class="col-lg-2 col-4 me-auto clients-item-height">
                            <img src="<?= base_url('assets/images/clients/profil-rejser.svg') ?>" class="clients-image img-fluid" alt="">
                        </div>
