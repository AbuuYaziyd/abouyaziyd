        ...
        <section class="col">
          <div class="card">
            <div class="card-header">
              <h3><b><?= lang('app.add') ?> <?= lang('app.project') ?></b><a href="<?= base_url('project') ?>" class="btn btn-warning btn-sm float-right"><i class="fas fa-arrow-left"></i> <?= lang('app.back') ?></a></h3>
            </div>
            <div class="card-body">
              <div class="row">
                <div class="col">
                  <?= form_open_multipart('project/create') ?>
                    ...
                    <div class="form-group">
                      ...
                      <textarea name="info" class="form-control" placeholder="<?= lang('app.projectInfo') ?>"></textarea>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputBorder"><?= lang('app.status') ?></label>
                      <select name="status" class="custom-select">
                        <option value="done"><?= lang('app.done') ?></option>
                        <option value="notDone" selected><?= lang('app.notDone') ?></option>
                      </select>
                    </div>
                    <div class="form-group">
